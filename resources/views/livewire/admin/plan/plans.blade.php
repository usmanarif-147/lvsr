    ...
    <div>
        <div class="d-flex justify-content-between">
            ...
            <h5 class="card-header">
                <a class="btn btn-primary" href="{{ url('admin/stripe-plan/create') }}"> Create
                </a>
            </h5>
        </div>
    </div>
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($plans['plans'] as $plan)
                                <tr>
                                    ...
                                    <td> {{ $plan->amount }}</td>
                                    <td>
                                        <span class="badge {{ model_status($plan)['background'] }} me-1">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                                <a class="btn btn-icon btn-outline-secondary" data-bs-toggle="tooltip"
                                                    ...
                                                    wire:click="deleteConfirmModal({{ $plan->id }})">
                                                ...
                                                <a class="btn btn-icon btn-outline-secondary" data-bs-toggle="tooltip"
                                                    ...
                                                    href="{{ url('admin/background-color/' . $plan->id . '/edit') }}">
                                                ...
                                                @if ($plan->status == 0)
                                                    <button class="btn btn-icon btn-outline-secondary"
                                                        ...
                                                        wire:click="activateConfirmModal({{ $plan->id }})">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                @else
                                                    <button class="btn btn-icon btn-outline-secondary"
                                                        ...
                                                        wire:click="deactivateConfirmModal({{ $plan->id }})">
